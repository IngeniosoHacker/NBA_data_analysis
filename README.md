...
erDiagram
  Draft {
    integer yearDraft
    integer numberPickOverall
    integer numberRound
    integer numberRoundPick
    varchar(255) namePlayer
    varchar(10) slugTeam
    varchar(255) nameOrganizationFrom
    varchar(100) typeOrganizationFrom
    integer idPlayer
    integer idTeam
    varchar(100) nameTeam
    varchar(100) cityTeam
    varchar(100) teamName
    varchar(10) PLAYER_PROFILE_FLAG
    varchar(50) slugOrganizationTypeFrom
    varchar(255) locationOrganizationFrom
  }
  Draft_Combine {
    integer yearCombine
    integer idPlayer
    varchar(100) nameFirst
    varchar(100) nameLast
    varchar(255) namePlayer
    varchar(10) slugPosition
    decimal(5,2) heightWOShoesInches
    decimal(5,2) heightWOShoes
    decimal(6,2) weightLBS
    decimal(5,2) wingspanInches
    decimal(5,2) wingspan
    decimal(5,2) reachStandingInches
    decimal(5,2) reachStandingO
    decimal(5,2) verticalLeapStandingInches
    decimal(5,2) verticalLeapMaxInches
    decimal(5,2) timeLaneAgility
    decimal(5,2) timeThreeQuarterCourtSprint
    integer repsBenchPress135
    decimal(5,2) pctBodyFat
    decimal(5,2) heightWShoesInches
    decimal(5,2) heightWShoes
    decimal(5,2) lengthHandInches
    decimal(5,2) widthHandInches
    decimal(5,2) timeModifiedLaneAgility
    varchar(50) setSpot15CornerLeft
    varchar(50) setSpot15BreakLeft
    varchar(50) setSpot15TopKey
    varchar(50) setSpot15BreakRight
    varchar(50) setSpot15CornerRight
    varchar(50) setSpot15CornerLeftCollege
    varchar(50) setSpot15BreakLeftCollege
    varchar(50) setSpot15TopKeyCollege
    varchar(50) setSpot15BreakRightCollege
    varchar(50) setSpot15CornerRightCollege
    varchar(50) setSpot15CornerLeftNBA
    varchar(50) setSpot15BreakLeftNBA
    varchar(50) setSpot15TopKeyNBA
    varchar(50) setSpotBreakRightNBA
    varchar(50) setSpotCornerRightNBA
    integer setSpot15CornerLeftMade
    integer setSpot15CornerLeftAttempted
    decimal(5,2) setSpot15CornerLeftPct
    integer setSpot15BreakLeftMade
    integer setSpot15BreakLeftAttempted
    decimal(5,2) setSpot15BreakLeftPct
    integer setSpot15TopKeyMade
    integer setSpot15TopKeyAttempted
    decimal(5,2) setSpot15TopKeyPct
    integer setSpot15BreakRightMade
    integer setSpot15BreakRightAttempted
    decimal(5,2) setSpot15BreakRightPct
    integer setSpot15CornerRightMade
    integer setSpot15CornerRightAttempted
    decimal(5,2) setSpot15CornerRightPct
    integer setSpot15CornerLeftCollegeMade
    integer setSpot15CornerLeftCollegeAttempted
    decimal(5,2) setSpot15CornerLeftCollegePct
    integer setSpot15BreakLeftCollegeMade
    integer setSpot15BreakLeftCollegeAttempted
    decimal(5,2) setSpot15BreakLeftCollegePct
    integer setSpot15TopKeyCollegeMade
    integer setSpot15TopKeyCollegeAttempted
    decimal(5,2) setSpot15TopKeyCollegePct
    integer setSpot15BreakRightCollegeMade
    integer setSpot15BreakRightCollegeAttempted
    decimal(5,2) setSpot15BreakRightCollegePct
    integer setSpot15CornerRightCollegeMade
    integer setSpot15CornerRightCollegeAttempted
    decimal(5,2) setSpot15CornerRightCollegePct
    integer setSpot15CornerLeftNBAMade
    integer setSpot15CornerLeftNBAAttempted
    decimal(5,2) setSpot15CornerLeftNBAPct
    integer setSpot15BreakLeftNBAMade
    integer setSpot15BreakLeftNBAAttempted
    decimal(5,2) setSpot15BreakLeftNBAPct
    integer setSpot15TopKeyNBAMade
    integer setSpot15TopKeyNBAAttempted
    decimal(5,2) setSpot15TopKeyNBAPct
    integer setSpotBreakRightNBAMade
    integer setSpotBreakRightNBAAttempted
    decimal(5,2) setSpotBreakRightNBAPct
    integer setSpotCornerRightNBAMade
    integer setSpotCornerRightNBAAttempted
    decimal(5,2) setSpotCornerRightNBAPct
    varchar(50) setOffDrib15BreakLeft
    varchar(50) setSpotOffDrib15TopKey
    varchar(50) setOffDrib15BreakRight
    varchar(50) setOnMove15
    varchar(50) setOnMoveCollege
    integer setOffDrib15BreakLeftMade
    integer setOffDrib15BreakLeftAttempted
    decimal(5,2) setOffDrib15BreakLeftPct
    integer setSpotOffDrib15TopKeyMade
    integer setSpotOffDrib15TopKeyAttempted
    decimal(5,2) setSpotOffDrib15TopKeyPct
    integer setOffDrib15BreakRightMade
    integer setOffDrib15BreakRightAttempted
    decimal(5,2) setOffDrib15BreakRightPct
    integer setOnMove15Made
    integer setOnMove15Attempted
    decimal(5,2) setOnMove15Pct
    integer setOnMoveCollegeMade
    integer setOnMoveCollegeAttempted
    decimal(5,2) setOnMoveCollegePct
    varchar(50) setOffDribBreakLeftCollege
    varchar(50) setOffDribTopKeyCollege
    varchar(50) setOffDribBreakRightCollege
    integer setOffDribBreakLeftCollegeMade
    integer setOffDribBreakLeftCollegeAttempted
    decimal(5,2) setOffDribBreakLeftCollegePct
    integer setOffDribTopKeyCollegeMade
    integer setOffDribTopKeyCollegeAttempted
    decimal(5,2) setOffDribTopKeyCollegePct
    integer setOffDribBreakRightCollegeMade
    integer setOffDribBreakRightCollegeAttempted
    decimal(5,2) setOffDribBreakRightCollegePct
  }
  Game {
    bigint GAME_ID PK
    integer SEASON_ID
    integer TEAM_ID_HOME
    varchar(10) TEAM_ABBREVIATION_HOME
    varchar(100) TEAM_NAME_HOME
    date GAME_DATE
    varchar(50) MATCHUP_HOME
    varchar(5) WL_HOME
    integer MIN_HOME
    integer FGM_HOME
    integer FGA_HOME
    decimal(5,3) FG_PCT_HOME
    integer FG3M_HOME
    integer FG3A_HOME
    decimal(5,3) FG3_PCT_HOME
    integer FTM_HOME
    integer FTA_HOME
    decimal(5,3) FT_PCT_HOME
    integer OREB_HOME
    integer DREB_HOME
    integer REB_HOME
    integer AST_HOME
    ...
    integer PF_HOME
    integer PTS_HOME
    integer PLUS_MINUS_HOME
    integer VIDEO_AVAILABLE_HOME
    integer TEAM_ID_AWAY
    varchar(10) TEAM_ABBREVIATION_AWAY
    varchar(100) TEAM_NAME_AWAY
    varchar(50) MATCHUP_AWAY
    varchar(5) WL_AWAY
    integer MIN_AWAY
    integer FGM_AWAY
    integer FGA_AWAY
    decimal(5,3) FG_PCT_AWAY
    integer FG3M_AWAY
    integer FG3A_AWAY
    decimal(5,3) FG3_PCT_AWAY
    integer FTM_AWAY
    integer FTA_AWAY
    decimal(5,3) FT_PCT_AWAY
    integer OREB_AWAY
    integer DREB_AWAY
    integer REB_AWAY
    integer AST_AWAY
    ...
    integer PF_AWAY
    integer PTS_AWAY
    integer PLUS_MINUS_AWAY
    integer VIDEO_AVAILABLE_AWAY
    date GAME_DATE_EST
    integer GAME_SEQUENCE
    integer GAME_STATUS_ID
    varchar(50) GAME_STATUS_TEXT
    varchar(50) GAMECODE
    integer HOME_TEAM_ID
    integer VISITOR_TEAM_ID
    varchar(10) SEASON
    integer LIVE_PERIOD
    varchar(10) LIVE_PC_TIME
    varchar(10) NATL_TV_BROADCASTER_ABBREVIATION
    varchar(50) LIVE_PERIOD_TIME_BCAST
    varchar(10) WH_STATUS
    varchar(50) TEAM_CITY_HOME
    integer PTS_PAINT_HOME
    integer PTS_2ND_CHANCE_HOME
    integer PTS_FB_HOME
    integer LARGEST_LEAD_HOME
    integer LEAD_CHANGES_HOME
    integer TIMES_TIED_HOME
    integer TEAM_TURNOVERS_HOME
    integer TOTAL_TURNOVERS_HOME
    integer TEAM_REBOUNDs_HOME
    integer PTS_OFF_TO_HOME
    varchar(50) TEAM_CITY_AWAY
    integer PTS_PAINT_AWAY
    integer PTS_2ND_CHANCE_AWAY
    integer PTS_FB_AWAY
    integer LARGEST_LEAD_AWAY
    integer LEAD_CHANGES_AWAY
    integer TIMES_TIED_AWAY
    integer TEAM_TURNOVERS_AWAY
    integer TOTAL_TURNOVERS_AWAY
    integer TEAM_REBOUNDS_AWAY
    integer PTS_OFF_TO_AWAY
    integer LEAGUE_ID
    integer GAME_DATE_DAY
    integer ATTENDANCE
    interval GAME_TIME
    varchar(100) TEAM_CITY_NAME_HOME
    varchar(100) TEAM_NICKNAME_HOME
    varchar(10) TEAM_WINS_LOSSES_HOME
    integer PTS_QTR1_HOME
    integer PTS_QTR2_HOME
    integer PTS_QTR3_HOME
    integer PTS_QTR4_HOME
    integer PTS_OT1_HOME
    integer PTS_OT2_HOME
    integer PTS_OT3_HOME
    integer PTS_OT4_HOME
    integer PTS_OT5_HOME
    integer PTS_OT6_HOME
    integer PTS_OT7_HOME
    integer PTS_OT8_HOME
    integer PTS_OT9_HOME
    integer PTS_OT10_HOME
    integer PTS_HOME_y
    varchar(100) TEAM_CITY_NAME_AWAY
    varchar(100) TEAM_NICKNAME_AWAY
    varchar(10) TEAM_WINS_LOSSES_AWAY
    integer PTS_QTR1_AWAY
    integer PTS_QTR2_AWAY
    integer PTS_QTR3_AWAY
    integer PTS_QTR4_AWAY
    integer PTS_OT1_AWAY
    integer PTS_OT2_AWAY
    integer PTS_OT3_AWAY
    integer PTS_OT4_AWAY
    integer PTS_OT5_AWAY
    integer PTS_OT6_AWAY
    integer PTS_OT7_AWAY
    integer PTS_OT8_AWAY
    integer PTS_OT9_AWAY
    integer PTS_OT10_AWAY
    bigint LAST_GAME_ID
    date LAST_GAME_DATE_EST
    integer LAST_GAME_HOME_TEAM_ID
    varchar(50) LAST_GAME_HOME_TEAM_CITY
    varchar(100) LAST_GAME_HOME_TEAM_NAME
    varchar(10) LAST_GAME_HOME_TEAM_ABBREVIATION
    integer LAST_GAME_HOME_TEAM_POINTS
    integer LAST_GAME_VISITOR_TEAM_ID
    varchar(50) LAST_GAME_VISITOR_TEAM_CITY
    varchar(100) LAST_GAME_VISITOR_TEAM_NAME
    varchar(50) LAST_GAME_VISITOR_TEAM_CITY1
    integer LAST_GAME_VISITOR_TEAM_POINTS
    integer HOME_TEAM_WINS
    integer HOME_TEAM_LOSSES
    varchar(100) SERIES_LEADER
    integer VIDEO_AVAILABLE_FLAG
    integer PT_AVAILABLE
    integer PT_XYZ_AVAILABLE
    integer HUSTLE_STATUS
    integer HISTORICAL_STATUS
  }
  Game_Inactive_Players {
    ...
    integer JERSEY_NUM
    integer TEAM_ID
    varchar(50) TEAM_CITY
    varchar(100) TEAM_NAME
    varchar(10) TEAM_ABBREVIATION
    bigint GAME_ID
  }
  Game_Officials {
    integer OFFICIAL_ID
  ...
  Player_Attributes {
    ...
    varchar(100) FIRST_NAME
    varchar(100) LAST_NAME
    varchar(255) DISPLAY_FIRST_LAST
    varchar(255) DISPLAY_LAST_COMMA_FIRST
    varchar(255) DISPLAY_FI_LAST
    varchar(100) PLAYER_SLUG
    date BIRTHDATE
    varchar(255) SCHOOL
    varchar(100) COUNTRY
    varchar(255) LAST_AFFILIATION
    varchar(20) HEIGHT
    integer WEIGHT
    integer SEASON_EXP
    varchar(10) JERSEY
    varchar(10) POSITION
    varchar(20) ROSTERSTATUS
    varchar(5) GAMES_PLAYED_CURRENT_SEASON_FLAG
    integer TEAM_ID
    varchar(100) TEAM_NAME
    varchar(10) TEAM_ABBREVIATION
    varchar(25) TEAM_CODE
    varchar(50) TEAM_CITY
    varchar(50) PLAYERCODE
    integer FROM_YEAR
    integer TO_YEAR
    varchar(5) DLEAGUE_FLAG
    varchar(5) NBA_FLAG
    varchar(5) GAMES_PLAYED_FLAG
    varchar(10) DRAFT_YEAR
    integer DRAFT_ROUND
    integer DRAFT_NUMBER
    decimal(5,1) PTS
    decimal(5,1) AST
    decimal(5,1) REB
    integer ALL_STAR_APPEARANCES
    decimal(5,1) PIE
  }
  Team_Attributes {
    integer ID PK
    ...
    varchar(50) CITY
    varchar(100) ARENA
    integer ARENACAPACITY
    varchar(100) OWNER
    varchar(100) GENERALMANAGER
    varchar(100) HEADCOACH
    varchar(100) DLEAGUEAFFILIATION
    varchar(255) FACEBOOK_WEBSITE_LINK
    varchar(255) INSTAGRAM_WEBSITE_LINK
    varchar(255) TWITTER_WEBSITE_LINK
  }
  Team_History {
    integer ID
    varchar(50) CITY
    varchar(100) NICKNAME
    integer YEARFOUNDED
    integer YEARACTIVETILL
  }

  Draft ||--o{ Player : "idPlayer > id"
  Draft ||--o{ Team_Attributes : "idTeam > ID"
  Draft_Combine ||--o{ Player : "idPlayer > id"
  Game_Inactive_Players ||--o{ Player : "PLAYER_ID > id"
  Game_Inactive_Players ||--o{ Team_Attributes : "TEAM_ID > ID"
  Game_Inactive_Players ||--o{ Game : "GAME_ID > GAME_ID"
  Game_Officials ||--o{ Game : "GAME_ID > GAME_ID"
  Player_Attributes ||--o{ Player : "ID > id"
  Player_Attributes ||--o{ Team_Attributes : "TEAM_ID > ID"
  Game ||--o{ Team_Attributes : "HOME_TEAM_ID > ID"
  Game ||--o{ Team_Attributes : "VISITOR_TEAM_ID > ID"
  Team_History ||--o{ Team_Attributes : "ID > ID"
```
